...
namespace DataAccess
{
   public  class ClsDetainedLicensesData
    {
        public static bool GetDetainedLicenseInfoByID(int DetainedID, ref int LicenseID, ref DateTime DetainDate,
        ...
        public static DataTable GetAllDetainedLicenses()
        {
            ...
            SqlConnection connection = new SqlConnection(ClsDVLDSettings.ConnectionsString);
             ...
             string query = "select * from DetaintedLicenses_View order by IsReleased ,DetainID;";
